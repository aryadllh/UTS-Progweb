    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/phpprac/FORUM/partial/_handlesignup.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="scpassword" name="scpassword" placeholder="Confirm Password">
                    </div>
